...
import com.sergei.pokhodai.expensemanagement.uikit.divider.DividerItem
import com.sergei.pokhodai.expensemanagement.uikit.divider.DividerItemView
...
object UikitModule {
    fun register() {
        RecyclerRegister.Builder()
            ...
            .add(clazz = DividerItem.State::class.java, onView = ::DividerItemView)
